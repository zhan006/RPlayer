    ...
    return(
        ...
        onMouseLeave={()=>dispatch({type:LEAVEVOLUME})}>
            <button onClick = {handleIconClick} className = {"icon"}>
                            {volume>0&&volume<=0.7&&<svg width="2em" height="2em" viewBox="0 0 16 16" className="bi bi-volume-down-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            {volume>0.7&&<svg width="2em" height="2em" viewBox="0 0 16 16" className="bi bi-volume-up-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            {volume==0&&<svg width="2em" height="2em" viewBox="0 0 16 16" className="bi bi-volume-mute-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
