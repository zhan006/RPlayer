        ...
        <div className = "buttonModule">
            ...
            <div className = {"rightButton"}>
                ...
                <button className = {"icon"} onClick = {()=>{handleFullScreen()}}>
                    {!isFullScreen && <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" className="bi bi-fullscreen" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {isFullScreen && <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" className="bi bi-fullscreen-exit" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
